...
export const DEFAULT_HERO_TEXTS: HeroTexts = {
  ...
  subtitle:
    "Подберём комплект под объект, высоту и срок аренды. Для клининговых компаний, автосалонов, ТЦ, УК и частных мастеров.",
  badge1: "Работа с земли — без вышек и лесов",
  badge2: "Подбор комплекта под объект",
  badge3: "Можно протестировать перед покупкой",
  ...
  items: [
    {
      ...
      desc: "Подбираем оборудование под высоту, тип фасада и задачи — не нужно разбираться самому.",
    },
    {
      title: "Без лишних вложений",
      desc: "Не нужно покупать дорогое оборудование — берёте в аренду под конкретный объект.",
    },
    {
      title: "Быстрый старт",
      desc: "Получаете готовый комплект и начинаете работу сразу.",
    },
    {
      title: "Поддержка",
      desc: "Помогаем разобраться с оборудованием и подсказываем, как работать.",
    },
  ],
};
